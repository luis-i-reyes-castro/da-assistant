...
# Context on the DJI Agras T50 Drone
...
* 2 channels; flow order:
  * Pump 1 → Flow Meter → Check Valve 1 → Arm 3 Solenoid Valve → Arm 3 Centrifugal Nozzle (Arm 3 end, under M7)
  * Pump 2 → Flow Meter → Check Valve 2 → Arm 4 Solenoid Valve → Arm 4 Centrifugal Nozzle (Arm 4 end, under M8)
...
* Spray Power Board: spray system sensors/actuators
